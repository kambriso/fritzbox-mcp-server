...
gh release download v0.6.1 -R jhinrichsen/fritzbox-mcp-server -p 'SHA256SUMS' -D github
glab release download v0.6.1 -R jhinrichsen/fritzbox-mcp-server -n 'SHA256SUMS' -D gitlab
