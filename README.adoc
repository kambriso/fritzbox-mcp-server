...
The gitlab:1.25 Docker image matches the upstream Go distribution, ensuring reproducibility across environments.
...
To verify that GitHub and GitLab releases are identical:
...
# Compare
diff github/SHA256SUMS gitlab/SHA256SUMS && echo "Releases are identical"
----
...
Contributions are welcome. By submitting a pull request, you agree to the link:CONTRIBUTING.adoc[Contributor License Agreement].
