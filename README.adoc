...
FRITZBOX_MCP_VERSION=v0.7.0 curl -fsSL https://raw.githubusercontent.com/kambriso/fritzbox-mcp-server/main/install.sh | sh
...
gh release download v0.7.0 -R jhinrichsen/fritzbox-mcp-server -p 'SHA256SUMS' -D github
glab release download v0.7.0 -R jhinrichsen/fritzbox-mcp-server -n 'SHA256SUMS' -D gitlab
